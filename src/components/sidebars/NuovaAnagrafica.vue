  ...
  <div v-else class="wrapper">
      ...
      <template #content>
        ...
        <div class="grid p-input-filled form-group">
          <div class="flex flex-column col-12 col-lg-4">
            ...
            <Dropdown :filter="true" v-model="anagraficaClienti.idCampagna" :options="origineOptions" optionLabel="nome"
              optionValue="id"></Dropdown>
          </div>
          <div class="flex flex-column col-12 col-lg-4">
            <label for="first-name">Proprietario</label>
            <Dropdown :filter="true" v-model="anagraficaClienti.idProprietario" :options="proprietarioOptions"
              optionLabel="text" optionValue="value">
            </Dropdown>
          </div>
          <div class="flex flex-column col-12 col-lg-4">
            <label for="first-name">Commerciale</label>
            <Dropdown :filter="true" v-model="anagraficaClienti.idCommerciale" :options="commercialeOptions"
              optionLabel="text" optionValue="value">
            </Dropdown>
          </div>
          ...
          <div class="flex flex-column col-12 col-lg-4">
            ...
            <InputText id="citizenship" type="text" v-model="anagraficaClienti.NazioneNascita" />
          </div>
          <div class="flex flex-column col-12 col-lg-4">
            <label for="citizenship">Regione</label>
            <InputText id="citizenship" type="text" v-model="anagraficaClienti.RegioneNascita" />
          </div>
          <div class="flex flex-column col-12 col-lg-4">
            <label for="citizenship">Provincia</label>
            <InputText id="citizenship" type="text" v-model="anagraficaClienti.ProvinciaNascita" />
          </div>
          <div class="flex flex-column col-12 col-lg-4">
            <label for="citizenship">Città</label>
            <InputText id="citizenship" type="text" v-model="anagraficaClienti.CittaNascita" />
          </div>
          ...
          <div class="flex flex-column col-12 col-lg-4">
            ...
            <InputText id="enterprise-name" type="text" v-model="anagraficaClienti.ORIGINE_LEAD" />
          </div>
          ...
          <div class="flex flex-column col-12 col-lg-4">
            ...
            <InputText id="enterprise-name" type="text" v-model="anagraficaClienti.MONTANTE" />
          </div>
          <div class="flex flex-column col-12 col-lg-4">
            <label for="enterprise-name">Rata</label>
            <InputText id="enterprise-name" type="text" v-model="anagraficaClienti.RATA" />
          </div>
          <div class="flex flex-column col-12 col-lg-4">
            <label for="enterprise-name">Durata</label>
            <InputText id="enterprise-name" type="text" v-model="anagraficaClienti.DURATA" />
          </div>
          <div class="flex flex-column col-12 col-lg-4">
            <label for="enterprise-name">Tipologia Prodotto</label>
            <InputText id="enterprise-name" type="text" v-model="anagraficaClienti.TIPOLOGIA_PRODOTTO" />
          </div>
          <div class="flex flex-column col-12 col-lg-4">
            <label for="enterprise-name">Istituto</label>
            <InputText id="enterprise-name" type="text" v-model="anagraficaClienti.ISTITUTO" />
          </div>
          <div class="flex flex-column col-12 col-lg-4">
          ...
          <div class="flex flex-column col-12 col-lg-4">
            ...
            <Calendar v-model="anagraficaClienti.DATA_POSSIBILE_RINNOVO"></Calendar>
          </div>
          <div class="flex flex-column col-12 col-lg-4">
            <label for="enterprise-name">Data Prossimo Contatto</label>
            <Calendar v-model="anagraficaClienti.DATA_PROSSIMO_CONTATTO"></Calendar>
          </div>
          <!-- <div class="flex flex-column col-12 col-lg-4">
            <label for="enterprise-name">Rata</label>
            <InputText id="enterprise-name" type="text" v-model="anagraficaClienti.importo_richiesto" />
    ...
    <Card v-if="showIndirizzi" class="mb-4">
      ...
      <template #content>
          ...
          <div class="flex justify-content-between " v-for="(item, index) of anagraficaClienti.indirizzi" :key="index">
            ...
            <div class="flex-grow-1  grid p-input-filled form-group" id="indirizzo">
              <div class="flex flex-column col-12 ">
                ...
                <Dropdown :filter="true" :options="tipiIndirizzoOptions" optionLabel="text" optionValue="value"
              ...
              <div class="flex flex-column col-12 col-lg-4">
                <label for="citizenship">Nazione</label>
                <InputText id="citizenship" type="text" v-model="item.Nazione" />
              </div>
              <div class="flex flex-column col-12 col-lg-4">
                <label for="citizenship">Regione</label>
                <InputText id="citizenship" type="text" v-model="item.Regione" />
              </div>
              <div class="flex flex-column col-12 col-lg-4">
                <label for="citizenship">Provincia</label>
                <InputText id="citizenship" type="text" v-model="item.Provincia" />
              </div>
              <div class="flex flex-column col-12 col-lg-4">
                <label for="citizenship">Città</label>
        ...
        <div v-if="mode == 'view'">
          <div class="flex flex-column justify-content-between mb-4"
            v-for="(item, index) of anagraficaClienti.indirizzi" :key="index">
    ...
    <Card v-if="showContatti" class="mb-4">
      ...
      <template #content>
          ...
          <div class="flex justify-content-between " v-for="(item, index) of anagraficaClienti.contatti" :key="index">
            ...
            <div class="flex-grow-1  grid p-input-filled form-group" id="contatto">
              <div class="flex flex-column col-12 ">
                ...
                <Dropdown :filter="true" :options="tipiContattoOptions" optionLabel="text" optionValue="value"
        ...
        <div v-if="mode == 'view'">
          <div class="flex flex-column justify-content-between mb-4" v-for="(item, index) of anagraficaClienti.contatti"
            :key="index">
    ...
    <Card v-if="showDocumenti" class="mb-4">
      ...
      <template #content>
          ...
          <div class="flex justify-content-between " v-for="(item, index) of anagraficaClienti.documenti" :key="index">
            ...
            <div class="flex-grow-1  grid p-input-filled form-group" id="documento">
              <div class="flex flex-column col-12 ">
                ...
                <Dropdown :filter="true" :options="tipidocumentoOptions" optionLabel="text" optionValue="value"
              ...
              <div class="flex flex-column col-12 col-lg-6">
                ...
                <Calendar v-model="item.dataScadenza" :minDate="new Date(item.dataRilascio) || new Date()"></Calendar>
              </div>
        ...
        <div v-if="mode == 'view'">
          ...
          <div class="flex flex-column justify-content-between mb-4"
            v-for="(item, index) of anagraficaClienti.documenti" :key="index">
    ...
    <Card>
      <template #content>
        <div class="flex justify-content-end mt-4">
          <Button @click="mode = 'edit'" v-if="mode == 'view'" label="Modifica"></Button>
          <Button v-else :loading="loading" label="Salva" @click="saveForm"></Button>
        </div>
      </template>
    </Card>
  </div>
  ...
  if (props.sidebarData) {
    ...
    serviceGET.read()
      .then(res => {
        ...
        anagraficaClienti.value.DATA_DECORRENZA = new Date(res.DATA_DECORRENZA)
        anagraficaClienti.value.DATA_POSSIBILE_RINNOVO = new Date(res.DATA_POSSIBILE_RINNOVO)
        anagraficaClienti.value.DATA_PROSSIMO_CONTATTO = new Date(res.DATA_PROSSIMO_CONTATTO)
      })
