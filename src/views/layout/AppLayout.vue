<template>
  <div :class="[
    ...
    <AppMenu :model="menu" @menuitem-click="onMenuItemClick" @menu-toggle="onMenuToggle" />
...
export default {
  ...
  created() {
    ...
    this.service.readCustomEndpoint('https://posadas-core.datarete.cloud/api/GetMainMenu')
      .then(res => {
        if (res) {
          this.menu = res.menu
        }
