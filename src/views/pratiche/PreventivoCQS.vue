      ...
      <template #content>
        <div class="flex flex-column justify-content-between">
          ...
          <div class="flex  justify-content-end w-full mt-4">
            <Button class="mr-2" @click="resettaFiltro" label="Resetta filtro"></Button>
      ...
      <div class="col-12 col-lg-4">
        ...
        <Card class="mt-4">
          <template #content>
            ...
            <div class="flex flex-column w-full mb-4" :class="{ 'not-valid-item': !valid_importoRata }">
          ...
          <Card v-if="item.Stato.length > 0" class="mb-4 py-4 px-2">
            ...
            <template #content>
              <div class="grid ">
                ...
                <div v-if="item.logo" class="col-4 flex justify-content-end">
                  <img style="width:100%" :src="'https://prestitosi.mediafacile.it/WS/preventivi/partner/' + item.logo">
                </div>
              </div>
...
function ricercaRisultati() {
  ...
  axios.post('https://prestitosi-core.datarete.cloud/api/Preventivatore/PreventivoCQS', objectToPost.value)
    .then(response => {
